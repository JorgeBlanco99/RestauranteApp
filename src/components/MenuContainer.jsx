  ...
  return (
      <section className='w-full my-6' id="menu">
          <div className='w-full flex flex-col items-center justify-center'>
              ...
              before:w-32 before:h-2 before:-bottom-2 before:-left-8 before:bg-gradient-to-tr from-blue-500 to-blue-300 transition-all
               ease-in-out duration-100'> Menu</p>
            ...
            <div className='w-full'>
                <Itemscontainer flag={false} data={foodItems?.filter(i => i.category === filter)}/>
            </div>
          </div>
      </section>
  )
